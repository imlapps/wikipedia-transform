...
class OpenAiSettings(Config):
    ...
    embedding_model_name: OpenAiEmbeddingModelName  = Field(default=OpenAiEmbeddingModelName.TEXT_EMBEDDING_3_LARGE)
    generative_model_name: OpenAiGenerativeModelName = Field(default=OpenAiGenerativeModelName.GPT_4O)
